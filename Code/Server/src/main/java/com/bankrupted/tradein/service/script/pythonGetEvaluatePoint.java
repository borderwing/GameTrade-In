package com.bankrupted.tradein.service.script;
...
public class pythonGetEvaluatePoint {
    public static String getPoints(String title,String platform){
        ...
        interpreter.execfile("F:\\Git\\Trade-In\\Code\\Server\\src\\main\\java\\com.bankrupted.tradein.service.script\\python\\Amazon.py");
